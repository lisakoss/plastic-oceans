  ...
  render() {
    ...
    if (this.state.width < 700) {
      ...
      if(this.state.userId == null) {
        navigation = (<div ref="navBar" id="nav-bar">
      ...
      navigation = (<div ref="navBar" id="nav-bar">
        ...
        <h1 id="app-title">Plastic Oceans</h1>
        <div id="nav-buttons">
          <button ref="discoverButton" className="nav-button selected" id="Discover" onClick={(e) => this.handleButtonClick(e)}>Discover</button>
          <button ref="footprintButton" className="nav-button" id="Footprint" onClick={(e) => this.handleButtonClick(e)}>Footprint</button>
          <button ref="quizzesButton" className="nav-button" id="Quizzes" onClick={(e) => this.handleButtonClick(e)}>Quizzes</button>
        </div>
